import { LogOut, Key, Users, MapPinned, Sun, Moon } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-[#0f1115] pb-20">
      <div className="px-5 pt-6 max-w-sm mx-auto">
        ...
        <div className="grid grid-cols-2 gap-3 mb-6">
          <StatCard icon={Key} label="Your code" value="7K2N-91XQ" />
          <StatCard icon={Users} label="Tracked by" value="0 accounts" />
        </div>
